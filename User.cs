    ...
    public class User
    {
        ...
        public async Task<string> GetIdTokenAsync(bool forceRefresh = false)
        {
            if (forceRefresh || this.Credential.IsExpired())
            {
                ...
                await this.config.UserManager.UpdateExistingUser(this);
            }
        ...
        public async Task DeleteAsync()
        {
            ...
            await this.config.UserManager.DeleteExistingUser(this.Uid);
        }
        ...
        public async Task<UserCredential> LinkWithCredentialAsync(AuthCredential credential)
        {
            ...
            await this.config.UserManager.UpdateExistingUser(userCredential.User);
